...
from modules.transition_parser_eds import TransitionParser


@Model.register("transition_parser_eds_multi_task")
class EdsTransitionParserMultiTaskWrapper(Model):
    def __init__(self,
                 vocab: Vocabulary,
                 word_dim: int,
                 hidden_dim: int,
        ...
        self.args = {
            ...
            "concept_label_dim": concept_label_dim,
            ...
            "concept_label_embedding": concept_label_embedding,
            "action_embedding": action_embedding,
            "initializer": initializer,
            "regularizer": regularizer,
            "actions_namespace": actions_namespace,
            "concept_label_namespace": concept_label_namespace,
            "text_field_embedder": text_field_embedder,
            "buffer": buffer,
            "stack": stack,
        }

    def create(self, text_field_embedder: TextFieldEmbedder,
